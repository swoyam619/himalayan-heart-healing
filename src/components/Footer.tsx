...
import logoBanner from "@/assets/logo-banner-indeera.png";
    ...
    <div className="container mx-auto px-4">
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
        <div className="md:col-span-5">
          <img src={logoBanner} alt="Indeera Healing" className="h-20 object-contain mb-4 opacity-80" loading="lazy" />
        ...
        <div className="md:col-span-7">
          <p className="text-primary-foreground/60 leading-[1.9] mb-8">
            Have questions? Want to say hello? I'd love to hear from you.
          </p>
      ...
      <div className="max-w-4xl mx-auto mt-16 pt-8 border-t border-primary-foreground/10">
        <p className="text-primary-foreground/30 text-xs">
          © {new Date().getFullYear()} Indeera Healing. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
